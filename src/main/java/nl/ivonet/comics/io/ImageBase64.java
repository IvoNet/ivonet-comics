...
public class ImageBase64 {
    ...
    public BufferedImage decodeToImage(final String imageString) {
        ...
        try {
            imageByte = this.decoder.decodeBuffer(imageString);
    ...
    /**
     * Encode a byte array to base 64 encoded string.
     *
    ...
    public String encodeToString(final BufferedImage image, final String type) {
        ...
        try {
            ...
            imageString = this.encoder.encode(imageBytes);
