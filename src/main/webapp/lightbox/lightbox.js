   ...
   this.$get = function ($document, $modal, $timeout, cfpLoadingBar,
      ...
      Lightbox.setImage = function (newIndex) {
         ...
         var success = function () {
            index = newIndex;
            Lightbox.image = Lightbox.images[index];
      ...
      Lightbox.prevImage = function () {
         Lightbox.setImage((index - 1 + Lightbox.images.length) % Lightbox.images.length);
      };
      ...
      Lightbox.nextImage = function () {
         Lightbox.setImage((index + 1) % Lightbox.images.length);
      };
